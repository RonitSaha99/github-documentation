...
2.  set global user name and user email for all repository/git folders (if you want to set different username and email for different git repository then remove --global)
    - set global user name: `git config --global user.name "Ronit-Saha"`
    - set global user email: `git config --global user.email "bughunter.ronit@gmail.com"`
...
### Lesson 7. git HEAD and undo practical
...
### Lesson 15. branching and merging locally

<br>

### Lesson 16. GitHub Issues

<br>

### Lesson 17. 2-way and 3-way merges
...
### Lesson 18. Merge Conflicts

- https://www.tutorialspoint.com/what-is-merge-conflict-in-git-how-to-handle-merge-conflicts

<br>
<h2>Git and GitHub Learning Video Sources:--</h2><br/>
   <b>1.For Bangla: https://youtube.com/playlist?list=PLgH5QX0i9K3qAW8DT6I0XOxC23qnA4FL-</b><br/>
   <b>2.For Hindi: https://youtu.be/zGq7T9gZH2k</b><br/>
   <b>3. For English: https://youtu.be/RGOj5yH7evk </b></br>
